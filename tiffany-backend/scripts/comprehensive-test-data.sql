...
BEGIN
    ...
    RAISE NOTICE '================================================';
    RAISE NOTICE 'Users:             ' || v_total_users::text;
    RAISE NOTICE 'Products:          ' || v_total_products::text;
    RAISE NOTICE 'Product Sizes:     ' || v_total_sizes::text;
    RAISE NOTICE 'Product Images:    ' || v_total_images::text;
    RAISE NOTICE 'Categories:         ' || v_total_categories::text;
    RAISE NOTICE 'Banners:           ' || v_total_banners::text;
    RAISE NOTICE 'Shopping Carts:    ' || v_total_carts::text;
    RAISE NOTICE 'Orders:            ' || v_total_orders::text;
    RAISE NOTICE 'Order Items:       ' || v_total_order_items::text;
    RAISE NOTICE '';
    RAISE NOTICE '================================================';
