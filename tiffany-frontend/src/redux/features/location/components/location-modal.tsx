          ...
          <FormBody contentClassName="space-y-[0.8125rem]">
            ...
            <div>
              <div className="space-y-[0.4875rem]">
                <div className="relative h-[10.4rem] rounded-[0.325rem] overflow-hidden border bg-muted">
            ...
            <div className="space-y-[0.65rem] pt-[0.4875rem] border-t">
              ...
              <button
                ...
                className={cn(
                  "w-full flex items-center gap-[0.4875rem] rounded-[0.325rem] border-2 p-[0.4875rem] text-left transition-all focus:outline-none",
                  isDefaultValue
                    ? "border-amber-300 bg-amber-50/50"
                    : "border-border hover:border-primary/30 hover:bg-muted/30"
                )}
              >
                <div className={cn("p-[0.325rem] rounded-[0.325rem] shrink-0", isDefaultValue ? "bg-amber-100" : "bg-muted")}>
