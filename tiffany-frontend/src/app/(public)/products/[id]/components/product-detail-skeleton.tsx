      ...
      <div className="grid grid-cols-1 lg:grid-cols-[2fr_3fr] gap-[1.3rem] lg:gap-[1.625rem]">
        ...
        <div className="flex gap-[0.4875rem]">
          <div className="flex flex-col items-center gap-[0.24375rem] w-[60px]">
            <Skeleton className="h-[0.975rem] w-[0.975rem] rounded-[0.325rem]" />
            {[1, 2, 3, 4].map((i) => (
        ...
        <div className="space-y-[0.8125rem] pt-[0.325rem]">
          ...
          <Skeleton className="h-[1.4625rem] w-4/5 rounded-[0.325rem]" />
          <Skeleton className="h-[1.95rem] w-[7.15rem] rounded-[0.325rem]" />
          ...
          <div className="flex gap-[0.325rem] items-center">
            <Skeleton className="h-[1.3rem] w-[3.9rem] rounded-[0.325rem]" />
            <Skeleton className="h-[1.3rem] w-[3.9rem] rounded-[0.325rem]" />
            <Skeleton className="h-[1.3rem] w-[5.2rem] rounded-[0.325rem] ml-auto" />
          </div>
