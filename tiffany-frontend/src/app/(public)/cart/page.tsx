  ...
  return (
    <>
        ...
        <div className="grid lg:grid-cols-3 gap-[0.65rem] sm:gap-[0.975rem]">
          ...
          <div className="hidden lg:block lg:col-span-1">
            <Card className="sticky top-[3.9rem]">
              ...
              <CustomButton className="w-full mb-[0.40625rem] gap-[0.325rem] h-[2.5rem] sm:h-[1.7875rem] rounded-[0.4875rem]" onClick={handleCheckout}>
      ...
      <div className="fixed bottom-nav-safe left-0 right-0 z-40 lg:hidden bg-background/95 backdrop-blur-sm border-t px-[0.65rem] py-[0.4875rem]">
        ...
        <CustomButton className="w-full gap-[0.325rem] h-[2.5rem] sm:h-[1.7875rem] rounded-[0.4875rem]" onClick={handleCheckout}>
          <CreditCard className="h-[0.65rem] w-[0.65rem]" />
          Proceed to Checkout
