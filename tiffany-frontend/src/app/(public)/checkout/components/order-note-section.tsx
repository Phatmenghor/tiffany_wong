...
export function OrderNoteSection({ customerNote, onNoteChange }: OrderNoteSectionProps) {
  return (
    <div className="bg-card border rounded-[0.65rem] p-[0.65rem] sm:p-[0.8125rem]">
      <h2 className="text-[13px] font-bold mb-[0.65rem] flex items-center gap-[0.325rem]">
      ...
      <textarea
        ...
        className="w-full border rounded-[0.4875rem] p-[0.4875rem] bg-background text-foreground text-[11px] resize-none"
        rows={4}
      />
    </div>
  );
