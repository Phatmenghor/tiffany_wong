  ...
  return (
    <div className="hidden lg:block lg:col-span-1">
      <div className="bg-card border rounded-[0.65rem] p-[0.8125rem] sticky top-[3.9rem]">
          ...
          <div className="flex gap-[0.325rem]">
            {(["CASH", "BANK"] as const).map((method) => (
              <button
                ...
                className={cn(
                  "flex-1 flex items-center justify-center gap-[0.325rem] h-[2.125rem] sm:h-[1.625rem] border rounded-[0.325rem] text-[12px] sm:text-[11px] font-medium transition-colors",
        ...
        <CustomButton
          className="w-full mb-[0.40625rem] gap-[0.325rem] h-[2.125rem] sm:h-[1.7875rem] rounded-[0.4875rem]"
          onClick={onCheckout}
