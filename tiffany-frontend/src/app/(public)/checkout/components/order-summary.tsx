    ...
    <div className="hidden lg:block lg:col-span-1">
      <div className="bg-card border rounded-[0.65rem] p-[0.8125rem] sticky top-[3.9rem]">
        <h2 className="text-[0.73125rem] font-bold mb-[0.65rem] flex items-center justify-between">
          ...
          <span className="text-[0.4875rem] font-normal text-muted-foreground bg-muted px-[0.325rem] py-[0.1625rem] rounded-lg">
        ...
        <div className="space-y-[0.4875rem] mb-[0.8125rem]">
          ...
          <div className="bg-muted/50 rounded-lg p-[0.4875rem] mb-[0.65rem]">
          ...
          {/* Discount */}
          {discountAmount > 0 && (
            <div className="flex justify-between text-[0.56875rem] bg-red-50/30 p-[0.40625rem] rounded-lg border border-red-200/50">
          ...
          {/* Total */}
          <div className="bg-primary/10 rounded-lg p-[0.4875rem] border border-primary/20">
        ...
        <div className="mb-[0.8125rem] p-[0.65rem] bg-muted/30 rounded-[0.4875rem] border">
          ...
          <div className="flex gap-[0.325rem]">
            <label className="flex-1 flex items-center gap-[0.325rem] cursor-pointer p-[0.40625rem] border rounded-lg hover:bg-muted/50 transition-colors" onClick={() => onPaymentMethodChange("CASH")}>
              <input
                type="radio"
                name="paymentMethod"
                value="CASH"
            ...
            <label className="flex-1 flex items-center gap-[0.325rem] cursor-pointer p-[0.40625rem] border rounded-lg hover:bg-muted/50 transition-colors" onClick={() => onPaymentMethodChange("BANK")}>
              <input
                type="radio"
                name="paymentMethod"
                value="BANK"
