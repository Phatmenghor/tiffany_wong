              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-[0.65rem]">
                <div className="space-y-[0.325rem]">
                  ...
                  <input
                    ...
                    className={`w-full h-[2.75rem] sm:h-[1.625rem] px-[0.4875rem] border rounded-[0.325rem] text-[12px] sm:text-[11px] bg-background placeholder:text-muted-foreground/50 focus:outline-none focus:ring-2 focus:ring-primary/30 transition-colors ${errors.name ? "border-red-500 focus:ring-red-300" : "border-input"}`}
                ...
                <div className="space-y-[0.325rem]">
                  ...
                  <input
                    ...
                    className={`w-full h-[2.75rem] sm:h-[1.625rem] px-[0.4875rem] border rounded-[0.325rem] text-[12px] sm:text-[11px] bg-background placeholder:text-muted-foreground/50 focus:outline-none focus:ring-2 focus:ring-primary/30 transition-colors ${errors.phone ? "border-red-500 focus:ring-red-300" : "border-input"}`}
                    disabled={isProcessing}
                  />
