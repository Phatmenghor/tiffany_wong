    ...
    <Card className="transition-shadow hover:shadow-md">
      <CardContent className="p-[0.4875rem]">
        <div className="flex items-center justify-between mb-[0.325rem]">
          ...
          <div className={cn("h-[1.1375rem] w-[1.1375rem] rounded-md flex items-center justify-center shrink-0", iconBg)}>{icon}</div>
        </div>
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-[0.4875rem]">
      {[...Array(4)].map((_, i) => (
        <Card key={i}><CardContent className="p-[0.4875rem]">
          <div className="flex items-center justify-between mb-[0.325rem]"><Skeleton className="h-[0.40625rem] w-[2.6rem]" /><Skeleton className="h-[1.1375rem] w-[1.1375rem] rounded-md" /></div>
