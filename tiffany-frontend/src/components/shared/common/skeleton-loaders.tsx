...
export function ChartSkeleton() {
  return (
    <div className="space-y-[0.65rem] p-[0.975rem]">
      ...
      <div className="h-[13rem] bg-gradient-to-b from-gray-100 to-gray-50 rounded-[0.325rem] animate-pulse">
        <div className="p-[0.65rem] space-y-[0.4875rem]">
          <div className="flex gap-[0.325rem]">
            {[...Array(15)].map((_, i) => (
              <div key={i} className="flex-1 space-y-[0.325rem]">
                <div className="h-[5.2rem] bg-gray-200 rounded-[0.08125rem] animate-pulse"></div>
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-[0.65rem]">
      {[...Array(4)].map((_, i) => (
        <div
          key={i}
          className="bg-white border border-gray-200 rounded-[0.325rem] p-[0.65rem] animate-pulse"
        >
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-[0.975rem]">
      {[...Array(2)].map((_, i) => (
        <div
          key={i}
          className="bg-gradient-to-br from-gray-50 to-gray-100 border-2 border-gray-200 rounded-[0.325rem] p-[1.3rem] animate-pulse"
        >
...
export function DashboardSkeleton() {
  return (
    <div className="p-[1.3rem] space-y-[1.3rem]">
      ...
      {/* Daily Trends Chart */}
      <div className="border-2 border-blue-200 rounded-[0.325rem] bg-white overflow-hidden">
        <ChartSkeleton />
      </div>

      {/* Revenue Bar Chart */}
      <div className="border-2 border-blue-300 rounded-[0.325rem] bg-white overflow-hidden">
        <ChartSkeleton />
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-[0.975rem]">
        {[...Array(3)].map((_, i) => (
          <div
            key={i}
            className="bg-white border-l-4 border-gray-300 p-[0.975rem] rounded-[0.325rem] animate-pulse"
          >
      ...
      {/* KPI Cards */}
      <div className="border border-gray-200 rounded-[0.325rem] p-[0.975rem]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-[0.975rem]">
        {[...Array(2)].map((_, i) => (
          <div
            key={i}
            className="border border-gray-200 rounded-[0.325rem] bg-white overflow-hidden"
          >
            <PieChartSkeleton />
          </div>
        ))}
