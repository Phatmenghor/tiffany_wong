          ...
          {showControls && (
            <div className="flex items-center justify-between gap-[0.4875rem]">
              ...
              <div className="flex items-center gap-[0.1625rem]">
                ...
                <div className="flex-1 text-center h-[1.3rem] bg-primary/10 text-primary font-semibold text-[0.56875rem] rounded-lg border border-primary/20 flex items-center justify-center w-[1.625rem]">
                  {quantity}
                </div>
                <CustomButton
                  size="icon"
