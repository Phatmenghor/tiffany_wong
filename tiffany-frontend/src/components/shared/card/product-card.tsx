            ...
            <div className="mt-auto">
              ...
              {isInCart ? (
                <div className="flex items-center gap-[0.24375rem] w-full">
                  ...
                  <div className="flex-1 text-center h-[1.3rem] bg-primary/10 text-primary font-semibold text-[0.56875rem] rounded-lg border border-primary/20 flex items-center justify-center">
                    {displayQuantity}
                  </div>
                  <CustomButton
                    size="icon"
