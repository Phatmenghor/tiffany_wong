      ...
      <Popover open={open} onOpenChange={setOpen} modal={true}>
        <PopoverTrigger asChild>
          <Button
            ...
            aria-expanded={open}
            className={cn(
              "w-full justify-between px-[0.4875rem] h-[2.125rem] sm:h-[1.625rem] text-[12px] sm:text-[12px] transition-all duration-200 border-input overflow-hidden",
          ...
          >
            {dataSelect ? (
              <span className="min-w-0 flex-1 truncate text-left">{dataSelect.fullAddress}</span>
            ) : (
