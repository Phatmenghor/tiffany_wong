          ...
          {isLoadingDetail ? (
            ...
            <>
              ...
              <div className="flex gap-[0.65rem] mb-[0.65rem]">
                <div className="relative w-[3.25rem] h-[3.25rem] rounded-lg overflow-hidden bg-muted flex-shrink-0">
                  <Image
                      ...
                      {displayProduct.sizes.map((size) => {
                        ...
                        return (
                          <button
                            ...
                            className={cn(
                              "relative border-2 rounded-lg px-[0.4875rem] py-[0.325rem] transition-all cursor-pointer hover:border-primary",
