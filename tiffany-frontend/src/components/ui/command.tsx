...
>(({ className, ...props }, ref) => (
  <CommandPrimitive
    ref={ref}
    className={cn(
      "flex h-full w-full flex-col overflow-hidden rounded-md bg-card text-card-foreground shadow-sm border border-border",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div className="flex items-center border-b border-border px-[0.4875rem] bg-card" cmdk-input-wrapper="">
    ...
    <CommandPrimitive.Input
      ref={ref}
      className={cn(
        "flex h-[1.625rem] w-full rounded-md bg-transparent py-[0.4875rem] text-[0.56875rem] outline-none placeholder:text-muted-foreground disabled:cursor-not-allowed disabled:opacity-50 focus:outline-none",
        className
      )}
      {...props}
    />
...
>((props, ref) => (
  <CommandPrimitive.Empty
    ref={ref}
    className="py-[0.975rem] text-center text-[0.56875rem] text-muted-foreground"
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Group
    ...
    className={cn(
      ...
      "[&_[cmdk-group-heading]]:text-[0.4875rem] [&_[cmdk-group-heading]]:font-semibold",
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex cursor-default gap-[0.325rem] select-none items-center rounded-sm px-[0.325rem] py-[0.24375rem] text-[0.56875rem] outline-none transition-colors",
      "hover:bg-muted",
...
const CommandShortcut = ({
  ...
  return (
    <span
      className={cn(
        "ml-auto text-[0.4875rem] tracking-widest text-muted-foreground",
        className
      )}
      {...props}
    />
