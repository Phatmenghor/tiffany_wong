  ...
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ...
      className={cn(
        ...
        "bottom-0 left-0 right-0 max-h-[92dvh] rounded-t-[0.65rem] border-t",
        "sm:bottom-auto sm:right-auto sm:left-1/2 sm:top-1/2",
        "sm:-translate-x-1/2 sm:-translate-y-1/2 sm:max-w-lg sm:rounded-[0.4875rem] sm:border",
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Title
    ref={ref}
    className={cn("text-[0.73125rem] font-semibold", className)}
    {...props}
  />
))
