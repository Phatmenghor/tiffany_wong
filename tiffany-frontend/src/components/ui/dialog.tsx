...
>(({
  ...
  <DialogPortal>
    ...
    >
      ...
      {children}
      <DialogPrimitive.Close className={`absolute right-[0.65rem] top-[0.65rem] rounded-[0.08125rem] opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-accent data-[state=open]:text-muted-foreground ${closeButtonClassName}`}>
...
const DialogHeader = ({
  ...
  <div
    className={cn(
      "flex flex-col space-y-[0.24375rem] text-left",
      className
    )}
    {...props}
  />
